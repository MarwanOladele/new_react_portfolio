      ...
      <div className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full h-[420px]">
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover gap-2">
            <div className="black-gradient w-10 h-10 rounded-full p-2 cursor-pointer" onClick={()=>window.open(source_code_link, '_blank')}>
              <img src={github} alt="github" />
            </div>
            <div className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer" onClick={()=>window.open(deployed_code_link, '_blank')}>
