...
const experiences = [
  ...
  },
  {
    ...
    points: [
      ...
      "Collaborated with the development team to plan and implement design specifications.",
  ...
  },
  {
    ...
    points: [
      "Developed and implemented features that enhance the user experience of web applications.",
      ...
      "Collaborated with the backend development team to integrate frontend components with server-side logic.",
    ],
  },
  {
